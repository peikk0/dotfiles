...
function kx --description "kubectx-like Kubernetes context switcher"
  set -l preview '
  ...
  '
  set -l context (kube_contexts | fzf --tmux center,60%,40% --prompt ' ' --preview $preview --preview-window bottom,3)
